...
<body>
    ...
    <section class="search-form">
        <form action="" method="POST">
            <input type="text" class="box" placeholder="Rechercher des produits..." name="search_box">
            <input type="submit" class="btn" value="Rechercher" name="search_btn">
        </form>
    </section>
    ...
    <section class="products" style="padding-top: 0;">
        <div class="box-container">
            ...
            <form action="" method="POST" class="box">
                ...
                <input type="submit" value="Ajouter à la liste de souhaits" name="add_to_wishlist" class="option-btn">
